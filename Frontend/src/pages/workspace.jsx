...
export function Workspace() {
    ...
    // const board = useSelector((storeState) => storeState.boardModule.board) // <-- Remove unused variable
    const [isBoardComposerOpen, setIsBoardComposerOpen] = useState(false)
    // const [boardToEdit, setBoardToEdit] = useState(boardService.getEmptyBoard()) // <-- Remove unused variable
    ...
    function closeBoardComposer() {
        ...
        // setBoardToEdit(boardService.getEmptyBoard()) // <-- Remove unused variable
    }
