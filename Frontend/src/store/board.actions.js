...
export async function removeGroup(groupId, boardId) {
    try {
        store.dispatch(getActionUpdateBoard(await boardService.removeGroup(groupId, boardId)))
        return groupId
    } catch (err) {
...
export async function removeTask(taskId, groupId, boardId) {
    try {
        store.dispatch(getActionUpdateBoard(await boardService.removeTask(taskId, groupId, boardId)))
        return taskId
    } catch (err) {
...
export async function saveTask(task, groupId, boardId) {
    try {
        ...
        await boardService.saveTask(task, groupId, boardId) // removed unused savedBoard
        return task
    } catch (err) {
